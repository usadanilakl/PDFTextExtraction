...
public class GetArray {
    ...
    public static List<String> getValves(String original) {
        int len = 11;
        String unit = "01-";
        String unitt = "02-";
        String bop = "00-";
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            if (allLetters(letters) && allNumbers(nubmers) && (unit01.equals(unitt)||unit01.equals(unit)||unit01.equals(bop))) {
                valves.add(sub.trim());
    ...
    public static String threeLetterEquipment3LetterType1(String original, String pid) {
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            if (allLetters(letters) && allNumbers(nubmers) && unit01.equals(unit) && sub.charAt(6) == ' '
                    && allLetters(type)) {
                System.out.println(
                        "\"" +
                                unit01.replaceAll(" ", "") +
    ...
    public static String threeLetterEquipment3LetterType2(String original, String pid) {
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            if (allLetters(letters) && allNumbers(nubmers) && unit01.equals(unit) && sub.charAt(8) == ' '
                    && allLetters(type)) {
                System.out.println(
                        "\"" +
                                unit01.replaceAll(" ", "") +
    ...
    public static String threeLetterEquipment2LetterType2(String original, String pid) {
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            // System.out.println("type = " + type);
            // System.out.println(sub.charAt(8));
            if (allLetters(letters) && allNumbers(nubmers) && unit01.equals(unit) && sub.charAt(7) == ' '
                    && allLetters(type)) {
                System.out.println(
                        "\"" +
                                unit01.replaceAll(" ", "") +
    ...
    public static String threeLetterEquipment3LetterTypeABC1(String original, String pid) {
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            // System.out.println(sub.charAt(6));
            if (allLetters(letters) && allNumbers(nubmers) && unit01.equals(unit) && sub.charAt(7) == ' '
                    && allLetters(type) && allLetters(lastLetter)) {
                System.out.println(
                        "\"" +
                                unit01.replaceAll(" ", "") +
                                type +
    ...
    public static String pipe4(String original, String pid) {
        ...
        for (int i = 0; i < original.length() - len; i++) {
            ...
            if (sub.startsWith(unit) && (sub.endsWith("\"MOH") || sub.endsWith("\"EOH") || sub.endsWith("\"MOC")
                    || sub.endsWith("\"EOC"))) {
                System.out.println(
                        "\"" +
                                sub +
